...
<div id="contenedorInformacion">
    ...
    <h3 style="width: 100%; text-align: center;"></h3>
    <div id="nuevasFT">


      <a href="pagosFacturas.php">
      <div id="nuevasFacturas">
      <div id="facturas" style="color: #597fe1;">Nuevas Facturas</div>
      ...
      <a href="tickets.php"><div id="nuevosTickets"><div id="tickets" style="color:#597fe1 ;">Tickets Abiertos</div>
      <div>
             <?php 
                if($seguimientos > "0"){
