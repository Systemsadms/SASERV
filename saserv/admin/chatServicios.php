...
<a href="index.php"><img src="img/arrowBlue.png" width="40px" height="40"></a><br>

  <h3 style="color: green;">Ticket de Servicio Nº: (<?php echo $ticket;?>)</h3>

   <h4>Cliente: <font color="#597fe1"><?php echo $clienteName; ?></font></h4>
  ...
  <input name="completado" type="submit" value="Completar Servicio" style="margin-bottom: 50px; background-color:red; height: 40px; color: white; width: 150px;" /> 
  ...
  <?php 
    if (isset($_POST['completado'])){
      ...
      require ("../cnx.php"); 
                                $actualizar = "UPDATE tickets SET 
                                estatus ='completado' WHERE ticket='$ticket'";     
                                $hacerconsulta = mysql_query ($actualizar);     
...
<?php
 if(isset($_POST['seguir']))
 {
  ...
  $contenido3   = "<b>TECNICO:</b> ".$_POST['contenido2'];
